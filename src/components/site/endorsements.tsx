  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-5 sm:px-8 lg:px-12">
        ...
        {/* Thesis pull-quote */}
        <Reveal delay={0.1}>
          <figure className="relative mx-auto mt-20 max-w-3xl border-l-2 border-rust/80 bg-charcoal/30 py-5 pl-7 pr-4 transition-colors duration-500 hover:bg-charcoal/50">
